...
const FastEnemy = preload("res://entities/enemies/fast_enemy/fast_enemy.tscn")
const Ranger = preload("res://entities/enemies/ranger/ranger.tscn")
const TestEnemy = preload("res://entities/enemies/test_enemy/test_enemy.tscn")
